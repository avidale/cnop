...
{p 4 7}{cmd:ziopprobabilities} shows the predicted probabilities estimated at the specified values of independent variables along with the standard errors.{p_end}
...
{pstd}Predicted probabilities of three types of zeros at the median values of independent variables{p_end}
...
{pstd}
{cmd:ziopmargins} [, {opt at(string)}  {opt zeros} {opt regimes} ]
...
{p 4 7}{cmd:ziopmargins} shows the marginal effects of each independent variable on the predicted probabilities estimated at the specified values of the independent variables along with the standard errors.{p_end}

{title:Examples for ziopmargins}
...
{pstd}Marginal effects on probabilities of three types of zeros at the median values of independent variables{p_end}
       . ziopmargins pr_zero, zeros
...
{pstd}
{cmd:ziopclassification} {ifin}


{title:Description for ziopclassification}
...
{title:References for ziopclassification}
